...
if((i < len)){
var k = (ks[i]);
var G__36428 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__36429 = (i + (1));
m = G__36428;
i = G__36429;
continue;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36331 = c;
var G__36331__$1 = (((G__36331 == null))?null:G__36331.prototype);
if((G__36331__$1 == null)){
return null;
} else {
return (G__36331__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__36332 = c;
var G__36332__$1 = (((G__36332 == null))?null:G__36332.prototype);
if((G__36332__$1 == null)){
return null;
} else {
return (G__36332__$1["render"]);
}
})() == null)))));
});
...
var G__36340 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__36340) : reagent.impl.component.as_element.call(null,G__36340));
};
...
var _STAR_current_component_STAR__orig_val__36342 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__36343 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__36343);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__36342);
}});
...
var c = this;
var G__36404_36436 = (c["cljsRatom"]);
if((G__36404_36436 == null)){
} else {
reagent.ratom.dispose_BANG_(G__36404_36436);
}
...
var renders_36438 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36439 = cljs.core.first(cljs.core.vals(renders_36438));
if((cljs.core.count(renders_36438) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36438))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36439)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36439], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__36412 = name;
switch (G__36412) {
case "":
...
var name = (function (){var G__36414 = fiber;
var G__36414__$1 = (((G__36414 == null))?null:(G__36414["type"]));
if((G__36414__$1 == null)){
return null;
} else {
return (G__36414__$1["displayName"]);
}
})();
var parent = (function (){var G__36415 = fiber;
if((G__36415 == null)){
return null;
} else {
return (G__36415["return"]);
}
})();
var path = (function (){var G__36416 = parent;
var G__36416__$1 = (((G__36416 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__36416) : reagent.impl.component.fiber_component_path.call(null,G__36416)));
if((G__36416__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36416__$1)," > "].join('');
}
})();
...
var temp__5751__auto__ = (function (){var or__4223__auto__ = (function (){var G__36417 = c;
if((G__36417 == null)){
return null;
} else {
return (G__36417["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
return G__36418._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4223__auto__ = (function (){var G__36419 = c;
if((G__36419 == null)){
return null;
} else {
return (G__36419["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var or__4223__auto____$1 = (function (){var G__36420 = c;
if((G__36420 == null)){
return null;
} else {
return G__36420._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4223__auto__ = (function (){var G__36421 = instance;
if((G__36421 == null)){
return null;
} else {
return (G__36421["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
} else {
var G__36422 = instance;
if((G__36422 == null)){
return null;
} else {
return G__36422._currentElement;
}
}
})();
var name = (function (){var G__36423 = elem;
var G__36423__$1 = (((G__36423 == null))?null:(G__36423["type"]));
if((G__36423__$1 == null)){
return null;
} else {
return (G__36423__$1["displayName"]);
}
})();
var owner = (function (){var or__4223__auto__ = (function (){var G__36424 = elem;
if((G__36424 == null)){
return null;
} else {
return (G__36424["_owner"]);
}
})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
return G__36425._owner;
}
}
})();
var path = (function (){var G__36426 = owner;
var G__36426__$1 = (((G__36426 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__36426) : reagent.impl.component.component_path.call(null,G__36426)));
if((G__36426__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36426__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__36427 = c;
var G__36427__$1 = (((G__36427 == null))?null:G__36427.constructor);
if((G__36427__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__36427__$1);
}
}
})();
